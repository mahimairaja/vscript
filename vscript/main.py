...
global validate, ref, debug, file, repl, parser, code, tree
validate, ref, debug, file, \
    repl, parser, code, tree = False, \
...
def vscript_cli(validate, ref, debug, file, repl):
    """_summary_

    Args:
        validate (bool): _description_
        ref (bool): _description_
        debug (bool): _description_
        file (str): _description_
        repl (str): _description_
